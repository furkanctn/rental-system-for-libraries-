...
// create four authors
        ...
        firstLibrary.addBook(new BookClass (1, "The Da Vinci Code", author1));
        firstLibrary.addBook(new BookClass(2, "Le Petit Prince", author2));
        firstLibrary.addBook(new BookClass(3, "A Tale of Two Cities", author3));
        firstLibrary.addBook(new BookClass(4, "The Lord of the Rings", author4));
        firstLibrary.addBook(new BookClass(5, "The Lord of the Rings", author4));
        firstLibrary.addBook(new Dictionary(6, "Oxford Dictionary of English", 6000));

        // Add three customers to the first library
        firstLibrary.addCustomer(new Customer("Ayse Caliskan", "İstanbul", 1995, "10 Green Brier Blv."));
        ...
        ArrayList<BookClass> list = firstLibrary.getBooks();
        if (!list.isEmpty()) {
        ...
        ArrayList<BookClass> list2 = secondLibrary.getBooks();
        if (!list2.isEmpty()) {
